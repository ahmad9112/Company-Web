    ...
    <section className="relative min-h-screen bg-[#FFEBA6] text-gray-900 overflow-hidden flex items-center">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 md:px-12 lg:px-20">
        <div className="max-w-2xl text-left">
          {/* Small Upper Title */}
          <p className="text-sm font-semibold tracking-wide uppercase mb-3">
            Connected Platform
          </p>
          ...
          <p className="text-base md:text-lg text-gray-800 mb-6">
            From sales to onboarding, customer support to renewals — DexKor covers the entire customer lifecycle. 
            One connected platform, AI-powered at its core, helping teams across SaaS, D2C, and Logistics deliver 
